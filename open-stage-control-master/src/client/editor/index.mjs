...
class Editor {
        ...
        this.inspector.on('update', (event)=>{
            ...
            for (var w of this.selectedWidgets) {
                ...
                try {
                    ...
                    newWidgets.push(updateWidget(w, {editedProps: [propName], preventSelect: this.selectedWidgets.length > 1}))

                } catch (e) {

                    w.props[propName] = previousValue
                    updateWidget(w, {editedProps: [propName], preventSelect: this.selectedWidgets.length > 1})
        ...
        for (var i = 0; i < this.selectedWidgets.length; i++) {
            ...
            if (deltaH !== 0 && w.props.height !== undefined && w.parent.getProp('layout') !== 'horizontal') {
                ...
                if (this.selectedWidgets.length > 1) {
                    ...
                    editedProps.push('top')
                }
            }

            if (w.props.width !== undefined || w.props.height !== undefined) newWidgets.push(updateWidget(w, {editedProps: editedProps, preventSelect: this.selectedWidgets.length > 1}))
    ...
    moveWidget(deltaX, deltaY) {
        ...
        for (var w of this.selectedWidgets) {
            ...
            newWidgets.push(updateWidget(w, {editedProps: ['top', 'left'], preventSelect: this.selectedWidgets.length > 1}))
    ...
    updateWidgetFromPatch(patch, indexes) {
        ...
        if (indexes) {
            ...
            options.editedProps = Object.keys(subpatch)
