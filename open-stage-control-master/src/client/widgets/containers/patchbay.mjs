    ...
    constructor(options) {
        ...
        this.on('draginit', (e)=>{
            ...
            if (e.target === this.canvas) {
                ...
                if (this.inputNodes.includes(e.target)) {
                    this.mousePosition = [e.offsetX - e.target.offsetWidth, e.offsetY + e.target.offsetTop]
                } else {
                    this.mousePosition = [e.offsetX + this.canvas.offsetWidth, e.offsetY + e.target.offsetTop]
                }
            }
        }, {element: this.widget})
        ...
        this.on('dragend', (e)=>{
            ...
            if (this.dragging) {
                // touch hover fix
                var node = e.isTouch ? document.elementFromPoint(e.clientX, e.clientY) : e.target
