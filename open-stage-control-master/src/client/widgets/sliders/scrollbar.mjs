...
export default class Scrollbar extends StaticProperties(Fader, {
    ...
    bindTarget(target) {
        ...
        fastdom.measure(()=>{
            if (!this.scrollTarget) return
            this.scrollTarget.on('scroll', this.targetScroll.bind(this))
            this.scrollTarget.on('resize', ()=>{
                if (this.scrollTarget) {
                    this.scrollTarget.trigger('scroll', {})
                    this.targetScroll({}, true)
                }
            }, {element: this.scrollTarget.widget})
            this.targetScroll({}, true)
        })
    ...
    targetScroll(e, init) {
        ...
        if (!this.scrollTarget || (e && e.locked)) return
    ...
    draw() {
        ...
        this.ctx.beginPath()
        // adjust position to keep knob within gauge boundaries
        d = (d - this.gaugePadding ) / (height - this.gaugePadding * 2 ) * (height - this.gaugePadding * 2 - knobHeight) + this.gaugePadding
