...
class Button extends Widget {
    ...
    static defaults() {
        ...
        var defaults = super.defaults(Button).extend({
            ...
            class_specific: {
                ...
                click: {type: 'boolean', value: false, help: 'Set to `true` to activate upon click event instead of tap (ignored if `mode` is `push`)'},
    ...
    constructor(options) {
        ...
        var mode = this.getProp('mode'),
            ...
            push = mode === 'push' || tap,
            click = this.getProp('click') && mode !== 'push'
        ...
        if (push) {
            ...
            if (this.getProp('doubleTap')) {
                ...
                }, {element: this.container, click: click})

            } else {

                this.on(click ? 'click': 'draginit',(e)=>{
        ...
        if (this.getProp('onTouch')) {
            this.on('drag',(e)=>this.onTouch(e, 'move'), {element: this.container})
